...
export const slashCommands = [
  ...
  new SlashCommandBuilder().setName('volume').setDescription('🔉 Set or check the volume')
    .addIntegerOption(o => o.setName('level').setDescription('Volume 0-200').setRequired(false).setMinValue(0).setMaxValue(200)),
  ...
  new SlashCommandBuilder().setName('remove').setDescription('🗑️ Remove a song from the queue')
    .addIntegerOption(o => o.setName('position').setDescription('Track number').setRequired(true).setMinValue(1)),
  new SlashCommandBuilder().setName('bassboost').setDescription('🔊 Set bass boost level')
  ...
  new SlashCommandBuilder().setName('filter').setDescription('🎛️ Apply an audio filter')
  ...
  new SlashCommandBuilder().setName('lyrics').setDescription('🎤 Get lyrics for a song')
    .addStringOption(o => o.setName('song').setDescription('Song name (blank = current song)').setRequired(false)),
